    ...
    <main>
      <div className="md:flex grid grid-col-12 justify-center items-center px-6">
        ...
        <div className="col-span-6 h-min w-full md:w-1/2  items-center justify-center  pt-6 pb-20">
          ...
          <div className="grid justify-center items-center">
            ...
            <h1 className="pl-6 text-5xl font-bold my-5 text-start ">
              Rent A Car <br></br> With CarHub  <br></br>
            </h1>
            <div className="font-semibold font-italic mt-6">
              The CarHub team has extensive experience in renting cars in Karachi,<br></br> allowing us to optimise your travel needs and make it <br></br>simple for you to find the ideal vehicle for your <br></br>journey. Our team of dedicated professionals strives <br></br>to make your trip more enjoyable and is available to <br></br>you 24 hours a day, seven days a week.

              <div className="mt-4 mb-8">
                CarHub Car Rental Service is widely regarded as<br></br> one of the best Car Rental Service Providers serving <br></br>not only Karachi but other major cities of Pakistan as well.
        ...
        <div className="col-span-6 h-min md:mt-10  pr-6 w-full  lg:w-1/2 items-center lg:block  justify-center pl-6 md:pl-20 ">
          ...
          <Image
            src="https://i.ibb.co/QJkJP0j/images.jpg"
            alt="Your GIF"
            width="350"
            height="450"
